...
class UserResourceTest {
    ...
    void before() {
        ...
        userDTO = new UserDTO(DEFAULT_EMAIL, DEFAULT_PASSWORD, DEFAULT_NAME, DEFAULT_NICKNAME, DEFAULT_PHONE_NUMBER, DEFAULT_GENDER);
    ...
    void joinUser_thenReturns200() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URI).contentType(MediaType.APPLICATION_JSON).content(content)).andExpect(status().isOk()).andDo(print());
...
//        String api = URI + "/" + 1;
//
//        ResultActions result = mockMvc.perform(get(api).contentType(MediaType.APPLICATION_JSON)).andDo(print());
//
